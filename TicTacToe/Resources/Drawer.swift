...
public class Drawer : NSObject {
    ...
    @objc dynamic public class func drawX(rect: CGRect = CGRect(x: 0, y: 0, width: 60, height: 60), leftLinePercent: CGFloat = 1, showLeftLine: Bool = false, rightLinePercent: CGFloat = 1, showRightLine: Bool = false, xStrokeWidth: CGFloat = 12) {
        ...
        Drawer.drawXSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, rect: CGRect(x: 0, y: 0, width: 60, height: 60), leftLinePercent: leftLinePercent, showLeftLine: showLeftLine, rightLinePercent: rightLinePercent, showRightLine: showRightLine, xStrokeWidth: xStrokeWidth)
        context.restoreGState()

        context.restoreGState()
    }

    @objc dynamic public class func drawO(rect: CGRect = CGRect(x: 0, y: 0, width: 60, height: 60), oStrokeWidth: CGFloat = 15, oLinePercent: CGFloat = 0.544, oBuffer: CGFloat = 4) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawVerticalLine(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 60), resizing: ResizingBehavior = .aspectFit, verticalLinePercent: CGFloat = 1, verticalLineFrame: CGRect = CGRect(x: 0, y: 0, width: 15, height: 60)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawHorizontalLine(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 60, height: 15), resizing: ResizingBehavior = .aspectFit, horizontalLinePercent: CGFloat = 1, horizontalLineFrame: CGRect = CGRect(x: 0, y: 0, width: 60, height: 15)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
