...
public class Drawer : NSObject {
    ...
    @objc dynamic public class func drawX(rect: CGRect = CGRect(x: 0, y: 0, width: 60, height: 60), left_length: CGFloat = 1, right_length: CGFloat = 1, x_stroke_width: CGFloat = 15) {
        ...
        if (show_right) {
            ...
            bezierPath.move(to: CGPoint(x: frame.minX + 0.84167 * frame.width, y: frame.minY + 0.15833 * frame.height))
            bezierPath.addLine(to: CGPoint(x: frame.minX + 0.14167 * frame.width, y: frame.minY + 0.85833 * frame.height))
